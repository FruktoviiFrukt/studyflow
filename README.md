...
| ------------------------- | -------------------------------------------------------------------- | -------------- | ------------------------- |
| Задания                   | `app/(main)/tasks`, `components/tasks`, `lib/tasks.ts`               | AlinaKernus    | UI готов, данные в памяти |
...
| AI Exam Coach             | `app/(main)/ai-coach`, `components/ai-coach`, `lib/ai-coach.ts`      | hellomumu      | генерация из демо-банка   |
